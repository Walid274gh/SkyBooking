...
public class MongoDBConnector {
   ...
   // Index pour recherche par ville (statistiques)
    ...
    // HÔTELS
    database.getCollection("hotels").createIndex(
        Indexes.ascending("hotelId")
    );
    database.getCollection("hotels").createIndex(
        Indexes.ascending("city", "availableRooms")
    );

    // RÉSERVATIONS HÔTELS
    database.getCollection("hotel_reservations").createIndex(
        Indexes.ascending("hotelReservationId")
    );
    database.getCollection("hotel_reservations").createIndex(
        Indexes.ascending("customerId")
    );
    database.getCollection("hotel_reservations").createIndex(
        Indexes.ascending("flightReservationId")
    );
