...
public class TicketPDFGenerator {
    ...
    public static byte[] generateSingleTicket(
        ...
        System.out.println("✅ PDF généré: " + filename + " (" + pdfBytes.length + " bytes)");
    ...
    private static void addSingleTicketPage(Document document, Ticket ticket, 
        ...
        addInfoLine(mainCell, "Arrivée prévue", ticket.arrivalDate + " à " + 
                   ticket.arrivalTime, boldFont, regularFont);
