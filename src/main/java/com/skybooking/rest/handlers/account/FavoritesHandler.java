...
public class FavoritesHandler implements HttpHandler {
    ...
    private void handleGet(HttpExchange exchange) throws Exception {
        ...
        Destination[] favorites = timeoutExecutor.executeWithTimeout(() -> 
    ...
    private void handlePost(HttpExchange exchange) throws Exception {
        ...
        // Appel CORBA avec timeout
        boolean added = timeoutExecutor.executeWithTimeout(() -> 
    ...
    private void handleDelete(HttpExchange exchange) throws Exception {
        ...
        // Appel CORBA avec timeout
        boolean removed = timeoutExecutor.executeWithTimeout(() -> 
