...
public class Constants {
    ...
    public static final String COLLECTION_HOTEL_RESERVATIONS = "hotel_reservations";
    ...
    public static final int POPULAR_DESTINATIONS_LIMIT = 6;
    
    // 🆕 ==================== DYNAMIC PACKAGING ====================
    public static final double FLIGHT_HOTEL_DISCOUNT = 15.0; // 15% de réduction
    public static final int MAX_HOTEL_ROOMS_PER_BOOKING = 10; // Limite par réservation
    public static final int MIN_HOTEL_STAR_RATING = 1;
    public static final int MAX_HOTEL_STAR_RATING = 5;
    ...
    public static final long TIMEOUT_HOTEL_SEARCH = 15L; // 🆕
    public static final long TIMEOUT_HOTEL_BOOKING = 20L; // 🆕
    ...
    public static final String HOTEL_IMAGES_DIR = "hotel_images"; // 🆕
    ...
    // 🆕 MESSAGES HÔTELS
    public static final String MSG_HOTEL_NOT_FOUND = "Hôtel non trouvé";
    public static final String MSG_NO_ROOMS_AVAILABLE = "Aucune chambre disponible";
    public static final String MSG_INVALID_CHECK_DATES = "Dates de séjour invalides";
    public static final String MSG_HOTEL_BOOKING_SUCCESS = "Réservation d'hôtel créée avec succès";
